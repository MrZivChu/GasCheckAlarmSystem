...
public class ChartManagerPanel : MonoBehaviour
{
    ...
    void OnEnable()
    {
        ...
        int pageCount = 0, rowCount = 0;
        List<HistoryDataModel> list = HistoryDataDAL.SelectAllHistoryDataByCondition(1, 500, string.Empty, string.Empty, System.DateTime.MinValue, System.DateTime.MinValue, out pageCount, out rowCount);
