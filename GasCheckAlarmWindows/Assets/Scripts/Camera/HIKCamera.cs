...
public class HIKCamera : MonoBehaviour
{
    ...
    public string tip;
    private string tport="8000";
    private string tuser="admin";
    //private string tpassword = "abc123456";
    private string tpassword = "bao608806";
    ...
    public void InitSDK()
    {
        ...
        else
        {
            ...
            Debug.Log("初始化成功");
            Login(tip, tport, tuser, tpassword);
        }
    }
    /// <summary>
    /// 登录（初始化->登录->获取视屏流）
    ...
    public void VideoBtnClick(int CameraIndex)
    {
        ...
        if (m_lRealHandle < 0)
        {
            ...
            lpPreviewInfo.dwDisplayBufNum = 300; //播放库显示缓冲区最大帧数
    ...
    public void RealDataCallBack(Int32 lRealHandle, UInt32 dwDataType, IntPtr pBuffer, UInt32 dwBufSize, IntPtr pUser)
    {
        ...
        //print(string.Format("{0}", milliseconds));
    }
    private byte[] VideoData;
    [NonSerialized]
    public bool isDataGet = false;
    /// <summary>
    /// 解码后视屏回调（YUV格式）
    /// </summary>
    ...
    public int zhenshu = 0;
    private int bianint = 0;
    void FixedUpdate()
    {
        //bianint++;
        //if (bianint > 2)
